...
class music(DirectObject):
    ...
    def __init__(self):
        ...
        self.music.append(loader.loadSfx("..//audio//Game2_Shane Drums Full.wav"))
        self.music.append(loader.loadSfx("..//audio//Game2_Shane Rhythm Guitar.wav"))
        self.music.append(loader.loadSfx("..//audio//Game2_Tom Hon Solo.wav"))
        self.music.append(loader.loadSfx("..//audio//Game2_Kevin hachacha.wav"))
        self.music.append(loader.loadSfx("..//audio//Game2_Shane Melody Guitar.wav"))
        self.music.append(loader.loadSfx("..//audio//Game2_Brian Backup Trumpet.wav"))
        self.music.append(loader.loadSfx("..//audio//Game2_Brian Backup Vocals.wav"))
        self.music.append(loader.loadSfx("..//audio//Game2_Brian Backup Vocals Hi.wav"))
        self.music.append(loader.loadSfx("..//audio//Game2_Kevin Backup Guitar.wav"))
        self.music.append(loader.loadSfx("..//audio//Game2_Shane upbeat Vidaurri.wav"))
        #self.music.append(loader.loadSfx("SFX//three - Copy (4).wav"))
        #self.music.append(loader.loadSfx("SFX//three - Copy (5).wav")) #TRIAL DELETE
